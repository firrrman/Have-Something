...
export default function Flower() {
  onload = () => {
    const c = setTimeout(() => {
      ...
      function appendTitle() {
        if (index < titles.length && titleElement) {
  ...
  return (
    <body className="not-loaded body">
      ...
      <h1 className="title text-5xl text-center">
        <span id="title" className="text-center text-5xl md:text-6xl"></span>
      </h1>

      <audio id="bg-audio" autoPlay>
        <source src="/sound/goodDays.mp3" type="audio/mpeg" />
